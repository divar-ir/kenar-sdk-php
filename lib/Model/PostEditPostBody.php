...
/**
 * PostEditPostBody Class Doc Comment
 *
 * @category Class
 * @package  Divar\KenarApiClient
 * @author   OpenAPI Generator team
 ...
 */
class PostEditPostBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostEditPostBody';
    ...
    */
    ...
    {
        return $this->container['image_paths'];
    }

    /**
     * Sets image_paths
     *
     * @param string[]|null $image_paths image_paths
     *
     * @return self
     */
    public function setImagePaths($image_paths)
    {
        if (is_null($image_paths)) {
