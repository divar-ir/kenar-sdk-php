...
/**
 * AddonsEvaluationRowSection Class Doc Comment
 *
 * @category Class
 * @package  Divar\KenarApiClient
 * @author   OpenAPI Generator team
 ...
 */
class AddonsEvaluationRowSection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'addonsEvaluationRowSection';
    ...
    */
    ...
    {
        return $this->container['section_color'];
    }

    /**
     * Sets section_color
     *
     * @param \Divar\KenarApiClient\Model\AddonsWidgetColor|null $section_color section_color
     *
     * @return self
     */
    public function setSectionColor($section_color)
    {
        if (is_null($section_color)) {
