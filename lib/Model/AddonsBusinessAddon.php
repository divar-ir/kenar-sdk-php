...
/**
 * AddonsBusinessAddon Class Doc Comment
 *
 * @category Class
 * @package  Divar\KenarApiClient
 * @author   OpenAPI Generator team
 ...
 */
class AddonsBusinessAddon implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'addonsBusinessAddon';
    ...
    */
     ...
     * @return string|null
     */
    public function getBusinessRef()
    {
        return $this->container['business_ref'];
    }

    /**
     * Sets business_ref
     *
     * @param string|null $business_ref business_ref
     *
     * @return self
     */
    public function setBusinessRef($business_ref)
    {
        if (is_null($business_ref)) {
