...
/**
 * ChatapiChatBotSendMessageResponse Class Doc Comment
 *
 * @category Class
 * @package  Divar\KenarApiClient
 * @author   OpenAPI Generator team
 ...
 */
class ChatapiChatBotSendMessageResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'chatapiChatBotSendMessageResponse';
    ...
    */
     ...
     *
     * @param string|null $conversation_id ID of the conversation created or updated
     *
     * @return self
     */
