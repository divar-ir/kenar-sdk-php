...
class PaymentReorderPostBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets extra_details
     *
     * @param string|null $extra_details Additional details that you want to send to the Kenar side. This field is optional and can be used to solve inconsistencies in the transaction.
     *
     * @return self
     */
