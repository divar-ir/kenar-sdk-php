...
/**
 * MessageImageData Class Doc Comment
 *
 * @category Class
 * @package  Divar\KenarApiClient
 * @author   OpenAPI Generator team
 ...
 */
class MessageImageData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MessageImageData';
    ...
    */
    ...
    {
        return $this->container['width_px'];
    }

    /**
     * Sets width_px
     *
     * @param int|null $width_px width_px
     *
     * @return self
     */
    public function setWidthPx($width_px)
    {
        if (is_null($width_px)) {
            throw new \InvalidArgumentException('non-nullable width_px cannot be null');
        }
        $this->container['width_px'] = $width_px;
