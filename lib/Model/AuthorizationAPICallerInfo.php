...
/**
 * AuthorizationAPICallerInfo Class Doc Comment
 *
 * @category Class
 * @package  Divar\KenarApiClient
 * @author   OpenAPI Generator team
 ...
 */
class AuthorizationAPICallerInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'authorizationAPICallerInfo';
    ...
    */
     ...
     * Gets scopes
     *
     * @return \Divar\KenarApiClient\Model\AuthorizationOAuthScope[]|null
     */
     ...
     * Sets scopes
     *
     * @param \Divar\KenarApiClient\Model\AuthorizationOAuthScope[]|null $scopes scopes
     *
     * @return self
     */
