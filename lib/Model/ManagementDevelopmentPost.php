...
/**
 * ManagementDevelopmentPost Class Doc Comment
 *
 * @category Class
 * @package  Divar\KenarApiClient
 * @author   OpenAPI Generator team
 ...
 */
class ManagementDevelopmentPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'managementDevelopmentPost';
    ...
    */
     ...
     * @return string|null
     */
    public function getMngToken()
    {
        return $this->container['mng_token'];
    }

    /**
     * Sets mng_token
     *
     * @param string|null $mng_token mng_token
     *
     * @return self
     */
    public function setMngToken($mng_token)
    {
        if (is_null($mng_token)) {
