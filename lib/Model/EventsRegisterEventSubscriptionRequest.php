...
/**
 * EventsRegisterEventSubscriptionRequest Class Doc Comment
 *
 * @category Class
 * @package  Divar\KenarApiClient
 * @author   OpenAPI Generator team
 ...
 */
class EventsRegisterEventSubscriptionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'eventsRegisterEventSubscriptionRequest';
    ...
    */
     ...
     * @return string|null
     */
    public function getEventResourceId()
    {
        return $this->container['event_resource_id'];
    }

    /**
     * Sets event_resource_id
     *
     * @param string|null $event_resource_id event_resource_id
     *
     * @return self
     */
    public function setEventResourceId($event_resource_id)
    {
        if (is_null($event_resource_id)) {
