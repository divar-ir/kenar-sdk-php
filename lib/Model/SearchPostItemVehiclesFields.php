...
/**
 * SearchPostItemVehiclesFields Class Doc Comment
 *
 * @category Class
 * @package  Divar\KenarApiClient
 * @author   OpenAPI Generator team
 ...
 */
class SearchPostItemVehiclesFields implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SearchPostItemVehiclesFields';
    ...
    */
    ...
    /**
     * Gets installment_sale
     *
     * @return string|null
     */
    public function getInstallmentSale()
    {
        return $this->container['installment_sale'];
    }

    /**
     * Sets installment_sale
     *
     * @param string|null $installment_sale installment_sale
     *
     * @return self
     */
    public function setInstallmentSale($installment_sale)
    {
        if (is_null($installment_sale)) {
            throw new \InvalidArgumentException('non-nullable installment_sale cannot be null');
        }
        $this->container['installment_sale'] = $installment_sale;
