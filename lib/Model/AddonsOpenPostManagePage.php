...
/**
 * AddonsOpenPostManagePage Class Doc Comment
 *
 * @category Class
 ...
 */
class AddonsOpenPostManagePage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'addonsOpenPostManagePage';
    ...
    */
     ...
     * Sets post_token
     *
     * @param string $post_token Token of the post to redirect to its management page
     *
     * @return self
     */
